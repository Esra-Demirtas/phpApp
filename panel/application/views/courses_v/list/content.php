<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Eğitim Listesi
            <a href="<?php echo base_url("courses/new_form"); ?>" class="btn btn-xs btn-outline btn-primary pull-right"><i class="fa fa-plus"></i> Yeni Ekle</a>
        </h4>
    </div>
    <div class="col-md-12">
                        ...
                        <?php foreach ($items as $item) { ?>
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td class="text-center w200">
                                    <button data-url="<?php echo base_url("courses/delete/$item->id"); ?>" type="button" class="btn btn-sm btn-danger btn-outline remove-btn"><i class="fa fa-trash"></i> Sil</button>
